...
function vr = visualize_responses_03_kp_zk(mouse,sess,rec,unit,sType,playdata)
global vp vd dm;  
...
%for KPawakeM72 session 6
%stim=stim([1 4]);
%stim(1).in_tr=stim(1).in_tr(19:46);
%stim(2).in_tr=stim(2).in_tr(20:45);
%in_stim = [1,3,8,6,7];
