...
function [vr] = visualize_responses_kp003(mouse,sess,rec,unit,sType)
global vp vd dm;  
...
% Now select the trials you want to keep;
in_tr=(first_tr:numel(vp.tr));
% vp.tr=vp.tr(in_tr)
vp.tr=vp.tr([146 151 154 156 157])
